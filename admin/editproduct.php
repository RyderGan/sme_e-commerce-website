...
if (isset($_POST['updatepro'])) {
	...
	$descri = mysqli_real_escape_string($con, $_POST['descri']);

	// Trim the product name
	$pname = trim($pname);

	// Update the database
	$query = "UPDATE products SET pName='$pname', price='$price', piece='$piece', description='$descri', available='$available', category='$category', type='$type', item='$item', pCode='$pCode' WHERE id='$epid'";
