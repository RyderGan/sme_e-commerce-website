...
<body>
	...
	<div class="categoryHeaders">
		<table>
			<tr>
				...
				<th><a href="Shampoo.php" class="selectedItem">Shampoo</a></th>
	...
	<div class="categoryList">
		<div>
		<?php 
			$getposts = mysqli_query($con, "SELECT * FROM products WHERE item ='shampoo'  ORDER BY id DESC LIMIT 10") or die(mysqlI_error($con));
							...
							<li style="float: left; padding: 0px 25px 25px 25px;">
								<div class="home-prodlist-img">
									<a href="view_product.php?pid='.$id.'">
										<img src="../image/products/shampoo/'.$picture.'" class="category-img">
									</a>
