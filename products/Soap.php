...
<body>
	...
	<div class="categoryHeaders">
		<table>
			...
			<tr>
				...
				<th><a href="Soap.php" class="selectedItem">Soap</a></th>
			</tr>
			</tr>
		</table>
	</div>
	<div class="categoryList">
		<div> 
		<?php 
			$getposts = mysqli_query($con, "SELECT * FROM products WHERE item ='soap'  ORDER BY id DESC LIMIT 10") or die(mysqlI_error($con));
							...
							<li style="float: left; padding: 0px 25px 25px 25px;">
								<div class="home-prodlist-img">
									<a href="view_product.php?pid='.$id.'">
										<img src="../image/products/soap/'.$picture.'" class="category-img">
									</a>
